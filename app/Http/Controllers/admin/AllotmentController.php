...
class AllotmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $transaction->ending_balance = ( $allotment->monthly_allocation($allotment->office_id, $allotment->month, $allotment->year) - Expense::get_total_expenses($allotment->office_id, null, $allotment->year)) + $allotment->amount;
